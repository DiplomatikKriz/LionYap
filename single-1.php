...
$guncelle = $baglan->prepare("update icerik set gosterim = gosterim+1 where id=?");
...
<html lang="tr">
<head>
    <title>İş - <?php echo DonusumGeriDondur($kayit['baslik']);?></title>
    <meta charset="UTF-8">
    <meta name="description" content="<?php echo DonusumGeriDondur($ayarCek['siteDescription']);?>">
    <meta name="keywords" content="<?php echo DonusumGeriDondur($ayarCek['siteKeywoerds']);?>">
